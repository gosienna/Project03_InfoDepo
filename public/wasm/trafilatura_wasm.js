/* @ts-self-types="./trafilatura_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function extract_markdown(html) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(html, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.extract_markdown(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./trafilatura_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('trafilatura_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
