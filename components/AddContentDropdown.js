...
export const AddContentDropdown = ({
  ...
  const hasPrimaryActions = !!(onNewNote || onAddYoutube || onAddUrl || onAddChannel || onAddFile || onAddImage || onAddMap);
  ...
  return React.createElement(
    ...
    isOpen && React.createElement(
      ...
      onAddMap && React.createElement(
        'button',
        {
          onClick: () => { setIsOpen(false); onAddMap(); },
          className: 'flex items-center gap-3 w-full px-4 py-3 text-sm text-gray-200 hover:bg-gray-700 transition-colors',
        },
        React.createElement(
          'svg',
          { xmlns: 'http://www.w3.org/2000/svg', className: 'h-4 w-4 text-green-400', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor' },
