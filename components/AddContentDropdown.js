...
export const AddContentDropdown = ({
  ...
  const hasPrimaryActions = !!(onNewNote || onAddYoutube || onAddUrl || onAddChannel || onAddFile || onAddImage);
  ...
  return React.createElement(
    ...
    React.createElement(
      'button',
      {
        ...
        className: 'flex items-center gap-2 bg-theme-500 hover:bg-theme-600 text-buttontext font-bold py-2 px-5 rounded-xl transition-all active:scale-95',
      },
      React.createElement(
        'svg',
    ...
    isOpen && React.createElement(
      'div',
      {
        className: 'absolute right-0 mt-1 w-48 bg-theme-50 border border-gray-200 rounded-xl shadow-xl z-50 overflow-hidden',
      ...
      onNewNote && React.createElement(
        ...
        React.createElement(
          'svg',
          { xmlns: 'http://www.w3.org/2000/svg', className: 'h-4 w-4 text-emerald-600', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor' },
      ...
      onAddYoutube && React.createElement(
        ...
        React.createElement(
          'svg',
          { xmlns: 'http://www.w3.org/2000/svg', className: 'h-4 w-4 text-red-600', fill: 'currentColor', viewBox: '0 0 24 24' },
      ...
      onAddUrl && React.createElement(
        ...
        React.createElement(
          'svg',
          { xmlns: 'http://www.w3.org/2000/svg', className: 'h-4 w-4 text-cyan-600', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor' },
      ...
      onAddChannel && React.createElement(
        ...
        React.createElement(
          'svg',
          { xmlns: 'http://www.w3.org/2000/svg', className: 'h-4 w-4 text-red-600', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor' },
      ...
      onAddFile && React.createElement(
        ...
        React.createElement(BookIcon, { className: 'h-4 w-4 text-theme-600' }),
        'Add File'
      ),
      onAddImage && React.createElement(
        'button',
        {
          onClick: () => { setIsOpen(false); onAddImage(); },
          className: 'flex items-center gap-3 w-full px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 transition-colors',
        },
        React.createElement(
          'svg',
          { xmlns: 'http://www.w3.org/2000/svg', className: 'h-4 w-4 text-teal-600', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor' },
      ...
      onAddDesk && React.createElement(
        'button',
        {
          ...
          className:
            'flex items-center gap-3 w-full px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 transition-colors' +
            (hasPrimaryActions ? ' border-t border-gray-200' : ''),
        },
        React.createElement(
          'svg',
          { xmlns: 'http://www.w3.org/2000/svg', className: 'h-4 w-4 text-theme-600', fill: 'none', viewBox: '0 0 24 24', stroke: 'currentColor' },
