    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('h2', { className: 'text-lg font-bold text-theme-900' }, 'Add YouTube Channel')
        ),
        React.createElement(
          'button',
          {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('label', { className: 'text-sm font-medium text-theme-700', htmlFor: 'ch-url' }, 'Channel URL'),
          React.createElement('input', {
            ...
            disabled: isFetching,
            className: 'bg-theme-50 border border-gray-300 text-theme-900 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-red-500 placeholder-theme-500 disabled:opacity-50',
          }),
          React.createElement('p', { className: 'text-xs text-theme-500 mt-1' },
        ...
        isFetching && React.createElement(
          'div',
          { className: 'flex items-center gap-2 text-sm text-theme-700' },
      ...
      React.createElement(
        ...
        React.createElement(
          'button',
          {
            onClick: onClose,
            disabled: isFetching,
            className: 'px-5 py-2 rounded-xl text-sm font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition-colors disabled:opacity-40',
          },
          'Cancel'
        ),
        React.createElement(
